    ...
    def surfaces(self, score):
        ...
        for instrument in score['instruments']:
            ...
            # change surface for rim clicks
                        ...
                        if instrument == 'cymbal' and 'surface' in note and 'rest' not in note:
                            if note['surface'] == 'u':
                                note['surface'] = 'a'
                                if 'cymbal' in note:
...
class MusicXMLConvertor(Convertor):
    ...
    def convert(self, score, settings):
        ...
        for instrument in score['instruments']:
            ...
            iMeasure = 1
            for measure in music:
                if 'timesignature' not in measure:
                    ...
                    for note in beat:
                        ...
                        if 'rest' in note:
                            ...
                            for surface in note['surface']:
                                ...
                                if instrument == 'cymbal':
                                    if 'cymbal' in note:
                                        if note['cymbal'] == 'slide' and 'stop' not in note:
                                            ret += '( '
                                        if note['cymbal'] == 'crashchoke':
                                            ret += ' ^^'
                                    if 'stop' in note:
