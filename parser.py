        ...
        for measure in music:
            ...
            for beat in measure['beats']:
                ...
                while i < z:
                    ...
                    a = beat[i]
                    b = beat[j]
                    if 'rest' in b and 'tuplet' not in b:  # don't condense rests within tuplets
                        a['duration'] /= 2
                        del beat[j]
                        i -= 1
                        z -= 1
...
for instrument in instruments:
    if instrument in doc and instrument not in settings['instruments']:
        del doc[instrument]
